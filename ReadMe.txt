Numercal solutions codes for the article titled “In-flight pyroclast cooling during mafic explosive eruptions: a numerical model” authored by
Chiedozie C. Ogbuagu, Kuang C. Lin, Thomas J. Jones and Silvio De Angelis and published in Earth and Planetary Science Letters.
...
D. Transport_model.m 				Solves for the trajectory of erupted pyroclast(s)			Exit velocity, launch angle(s), pyroclast density and diameter
